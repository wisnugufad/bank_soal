<?php 
  ...
  $sql = "SELECT a.*, b.name as jenjang_name FROM subject as a JOIN jenjang as b ON b.id = a.jenjang_id";
  $query = MYSQLI_QUERY($connect,$sql);

  $sqlJenjang = "SELECT * FROM jenjang";
  $queryJenjang = MYSQLI_QUERY($connect,$sqlJenjang);
?>
                    ...
                    <div class="panel-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td hidden><?php echo $row['jenjang_id'] ?></td>
                          <td><?php echo $row['jenjang_name'] ?></td>
                ...
                <form action="" method="post">
                  <div class="modal-body">
                        ...
                        <select name="jenjang_id" id="jenjang_id" class="form-control">
                          <?php 
                            while ($rowJenjang = MYSQLI_FETCH_ASSOC($queryJenjang)) {
                          ?>
                              <option value="<?php echo $rowJenjang['id']; ?>"><?php echo $rowJenjang['name'] ?></option>
                          <?php
                            }
                          ?>
                        </select>
